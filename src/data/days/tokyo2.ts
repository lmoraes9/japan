    ...
    stops: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'A outra versão, o **multi-idioma** (¥69.980), essa sim faz tudo — mas esqueçam: ela não existe no desenho de Zelda, **não é vendida em loja nenhuma** (nem na Nintendo TOKYO — é online, e só), a loja online **não entrega em hotel**, **não aceita cartão estrangeiro** e exige conta japonesa com 50 h de jogo acumuladas até maio. No Japão, ou é o japonês, ou não é.',
