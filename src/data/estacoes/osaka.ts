...
export const OSAKA: MapaEstacoes = {
  ...
  bases: [
    { estacaoId: 'nippombashi', nome: 'KOKO Hotel · Sennichimae', dx: 54, dy: 40, stageId: 'osaka' },
  ...
  estacoes: [
    { id: 'umeda', nome: 'Osaka · Umeda', jp: '大阪 · 梅田', x: 170, y: 110, troca: true, destaque: true, lado: 'l', nota: 'três prédios diferentes ligados por baixo. JR → metrô: saída 御堂筋口, 2 min. Metrô → Hankyu: catraca norte e placa 阪急電車, 6 min' },
    ...
    { id: 'namba', nome: 'Namba', jp: 'なんば', x: 170, y: 380, troca: true, destaque: true, lado: 'l', nota: 'metrô Midōsuji. Do hotel são 8 min (saída 16); a Nippombashi é bem mais perto' },
    { id: 'nankai-namba', nome: 'Nankai Namba', jp: '南海なんば', x: 195, y: 428, troca: true, lado: 'l', nota: 'plataformas no **3º andar** do prédio da Takashimaya — não é a estação do metrô. Linha Kōya nas vias 1 a 4; 551 Hōrai e 7-Eleven na catraca norte' },
    { id: 'nippombashi', nome: 'Nippombashi', jp: '日本橋', x: 250, y: 382, troca: true, destaque: true, lado: 'r', nota: 'a estação do hotel: **saída 2, 1 min**. Saída 10 → galeria do Kuromon' },
